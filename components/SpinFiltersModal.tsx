    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent raw className="bg-slate-50 dark:bg-slate-900 border-none">
                <DialogHeader onClose={onClose} className="border-b dark:border-white/5 py-4">
                    <DialogTitle className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold text-slate-800 dark:text-white">Filter Your Spin</span>
                    </DialogTitle>
                </DialogHeader>

                <div className="flex-1 overflow-y-auto overscroll-contain px-6 py-6 pb-24 md:pb-6 space-y-6 custom-scrollbar min-w-0">
                    {/* Category Filter */}
                            ...
                            {WEATHER_TYPES.map((w) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`p-2 rounded-lg text-[10px] font-medium transition-colors border flex flex-col items-center gap-1 ${weather === w.id
                                            ? "bg-amber-500 text-white border-amber-500 shadow-md"
                                            : "bg-white dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/10"
                                            }`}
                                    >
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            >
                                ...
                                <div className="text-left">
                                    ...
                                    <div className="text-[10px] line-clamp-1">Trips & Outings</div>
                                </div>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <div className="text-left">
                                    ...
                                    <div className="text-[10px] line-clamp-1">No Driving</div>
                                </div>
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="py-2">
                        <Button onClick={handleSpin} className="w-full shadow-lg shadow-secondary/25">
