...
export const CONCIERGE_CONFIGS: Record<string, ConciergeToolConfig> = {
    ...
    NIGHTCLUB: {
        ...
        icon: Music,
        colorTheme: 'pink',
        endpoint: '/api/nightlife-concierge',
    ...
    WELLNESS: {
        ...
        icon: Leaf,
        colorTheme: 'emerald',
        endpoint: '/api/wellness-concierge',
        categoryType: 'ACTIVITY',
        hasLocation: true,
        hasPrice: true,
        sections: [
    ...
    FITNESS: {
        ...
        icon: Dumbbell,
        colorTheme: 'orange',
        endpoint: '/api/fitness-concierge',
        categoryType: 'ACTIVITY',
        hasLocation: true,
        hasPrice: true,
        sections: [
    ...
    THEATRE: {
        ...
        icon: Ticket,
        colorTheme: 'rose',
        endpoint: '/api/theatre-concierge',
        categoryType: 'ACTIVITY',
        hasLocation: true,
        hasPrice: true,
        sections: [
    ...
    ESCAPE_ROOM: {
        ...
        icon: Key,
        colorTheme: 'indigo',
        endpoint: '/api/escape-room-concierge',
        categoryType: 'ACTIVITY',
        hasLocation: true,
        hasPrice: false,
        sections: [
